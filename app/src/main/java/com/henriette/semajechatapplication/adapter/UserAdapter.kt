package com.henriette.semajechatapplication.adapter
...
class UserAdapter(private val context: Context, private val userList:ArrayList<User>) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        Glide.with(context).load(user.userImage).placeholder(R.drawable.ic_launcher_foreground).into(holder.imgUser)
    }
